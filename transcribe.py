...
authenticator = IAMAuthenticator('EchTPVgTZqgQsA6m37o5anNRlsSeb6u4pjGW-E3FyY8S')
text_to_speech = TextToSpeechV1(
    authenticator=authenticator
)

text_to_speech.set_service_url('https://api.us-south.speech-to-text.watson.cloud.ibm.com/instances/a4971d0b-a881-4532-bbc5-4fb87335b344')
...
def on_message(self, msg):
    ...
    off for later.
    """
    url = 'https://api.us-south.text-to-speech.watson.cloud.ibm.com/instances/f7615cda-161c-46c9-8754-e3541aabf5c0'
    APIKEY = 's1w7KWuFOinhbg_LEN93H2oT47tMoEtRbRyLI02gDM0t'
    # Setup Services
